...
export const PERMISSION_MATRIX: PermissionRow[] = [
  { label: "Dashboard", admin: "View", member: "View" },
  { label: "Team scheduling", admin: "View and edit", member: "View and edit" },
  { label: "Projects", admin: "View and edit", member: "View only" },
  { label: "Time tracking", admin: "Log and edit for anyone", member: "Log and edit own hours only" },
  { label: "Reports", admin: "View and export CSV", member: "View only" },
  { label: "Settings — company defaults", admin: "Edit", member: "View only" },
  { label: "Settings — schedule team", admin: "Add and edit members", member: "Hidden" },
  { label: "Settings — app access", admin: "Invite users and manage roles", member: "Hidden" },
];
